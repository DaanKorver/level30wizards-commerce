...
export type LegalFragment = { __typename?: 'ShopPolicy', title: string, body: string, handle: string };

export type MenuFragment = { __typename?: 'Menu', items: Array<{ __typename?: 'MenuItem', title: string, url?: any | null }> };
...
export type ProductFragment = { __typename?: 'Product', id: string, handle: string, title: string, tags: Array<string>, metafield?: { __typename?: 'Metafield', value: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, values: Array<string> }>, priceRange: { __typename?: 'ProductPriceRange', minVariantPrice: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } }, media: { __typename?: 'MediaConnection', nodes: Array<{ __typename?: 'ExternalVideo' } | (
      { __typename?: 'MediaImage' }
      & ImageFragment
...
export type GetLayoutQuery = { __typename?: 'QueryRoot', shop: { __typename?: 'Shop', name: string, description?: string | null, primaryDomain: { __typename?: 'Domain', url: any }, privacyPolicy?: (
      { __typename?: 'ShopPolicy' }
      & LegalFragment
    ) | null, refundPolicy?: (
      { __typename?: 'ShopPolicy' }
...
export type GetProductsQuery = { __typename?: 'QueryRoot', products: { __typename?: 'ProductConnection', nodes: Array<(
      { __typename?: 'Product' }
      & ProductFragment
    )> } };
...
export type GetProductSlugsQuery = { __typename?: 'QueryRoot', products: { __typename?: 'ProductConnection', nodes: Array<{ __typename?: 'Product', handle: string }> } };
...
export type GetProductByHandleQuery = { __typename?: 'QueryRoot', productByHandle?: (
    { __typename?: 'Product' }
    & ProductFragment
  ) | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getLayout(variables?: GetLayoutQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetLayoutQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLayoutQuery>(GetLayoutDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getLayout', 'query');
    },
    ...
    getProductSlugs(variables?: GetProductSlugsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetProductSlugsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductSlugsQuery>(GetProductSlugsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProductSlugs', 'query');
    },
...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    useGetLayout(key: SWRKeyInterface, variables?: GetLayoutQueryVariables, config?: SWRConfigInterface<GetLayoutQuery, ClientError>) {
      return useSWR<GetLayoutQuery, ClientError>(key, () => sdk.getLayout(variables), config);
    },
    useGetProducts(key: SWRKeyInterface, variables?: GetProductsQueryVariables, config?: SWRConfigInterface<GetProductsQuery, ClientError>) {
      return useSWR<GetProductsQuery, ClientError>(key, () => sdk.getProducts(variables), config);
    },
    useGetProductSlugs(key: SWRKeyInterface, variables?: GetProductSlugsQueryVariables, config?: SWRConfigInterface<GetProductSlugsQuery, ClientError>) {
      return useSWR<GetProductSlugsQuery, ClientError>(key, () => sdk.getProductSlugs(variables), config);
    },
